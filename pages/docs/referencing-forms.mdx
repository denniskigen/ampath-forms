...
You can build your forms in the Form Builder by referencing [components](/docs/core-concepts#components). Components group together reusable form logic. You can mix and match components to create forms of arbitrary complexity.
...
## Referencing the Pre-Clinic Review section from our component
...
You can follow this approach to reference as many component forms as you wish.
