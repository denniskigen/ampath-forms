...
You can build your forms in the Form Builder by referencing [components](/core-concepts#components). Components group together reusable form logic. You can mix and match components to create forms of arbitrary complexity.
