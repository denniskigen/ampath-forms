...
> **Angular Form Engine scope.** This page applies only to distributions that explicitly include `@openmrs/esm-form-entry-app`. For the Reference Application's default React workflow, use the [canonical O3 Forms guide](https://o3-docs.openmrs.org/en-US/docs/forms-in-o3/).

The Angular Form Engine lives in the [openmrs-ngx-formentry](https://github.com/openmrs/openmrs-ngx-formentry) repository and is published to npm as [`@openmrs/ngx-formentry`](https://www.npmjs.com/package/@openmrs/ngx-formentry). It leverages the [Carbon design system](https://carbondesignsystem.com/) to match the look and feel of [OpenMRS 3.x](https://dev3.openmrs.org/openmrs/spa) (O3). O3 frontends consume it through the [esm-form-entry-app](https://github.com/openmrs/openmrs-esm-patient-chart/tree/main/packages/esm-form-entry-app) package in the Patient Chart.
...
<Callout emoji="ℹ️" type="info">
  ...
  module. The O3 Form Builder previews and targets React; it does not validate
  forms for this Angular engine. There is currently no supported visual builder
  for the Angular engine. This guide covers the Angular engine.
</Callout>
