...
> **Archived AMPATH Form Builder documentation.** This page describes deploying `ampath/ngx-openmrs-formbuilder` for teams maintaining an existing installation. It is not a supported builder or preview for the current Angular Form Engine. See [About this documentation](/docs/about-this-documentation).
