...
> **Archived AMPATH Form Builder documentation.** This page describes the legacy builder's component workflow. It is not a supported authoring or preview workflow for the current Angular Form Engine. See [About this documentation](/docs/about-this-documentation).

You can construct forms in the legacy Form Builder by referencing [components](/docs/core-concepts/components). Components group together reusable form logic that can be combined across forms.
